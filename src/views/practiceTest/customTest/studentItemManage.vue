<template>
  <div>
        ...
        <div class="top-search addClass" @keydown.enter="querySearch">
            <div class="left-input">
                <div style="margin:5px 20px;">
                    <span>年级：</span>
                    <Select v-model="formList.grade" disabled style="width:120px" @on-change="selectClass">
                        <Option
    ...
    <Modal
      ...
      cancel-text="取消"
    >
      <p style="color: #515a6e; font-size: 16px">该学生已测试，移除学生后，其成绩对应删除，是否确认移除该学生？</p>
    </Modal>
    <add-modal
  ...
  methods: {
    ...
    async queryGradeList() {//查询学校所有年级
      ...
      if(res.data.code == 10000) {
        ...
        this.selectClass(this.$route.query.grade);
        this.queryStudentMsg();
      }
    },
