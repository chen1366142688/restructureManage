...
<template>
  <div style="padding-left: 10px">
    ...
    <Tabs type="card" :value="selectTabName" @on-click="selectTabs">
      ...
      >
        <div
          v-if="gradeData.gradeId == grade.gradeId"
          v-for="(gradeData, indexa) in allData"
        >
          <div>
                        ...
                        <Row>
                          ...
                          >
                            ...
                            <div
                              class="openBtn"
                              @click="
                                openOrCloseFun(classTestInfo, indexa, indexb, 1)
                              "
                            >
                        ...
                        <Row>
                          ...
                          >
                            ...
                            <div
                              class="openBtn"
                              @click="
                                openOrCloseFun(classTestInfo, indexa, indexb, 2)
                              "
                            >
                              {{ classTestInfo.open ? "收起" : "展开" }}
                              <Icon
                            ...
                            >
                              <div>
                                <p
                                  ...
                                  "
                                  v-html="
                                    '测试场地：' + detailInfo.testPlaceRemark
                                  "
                                ></p>
                                <div
                                  class="imgData"
                              ...
                              <div>
                                <p
                                  ...
                                  "
                                  v-html="
                                    '测试方法：' + detailInfo.testMethodsRemark
                                  "
                                ></p>
                                <div
                                  class="imgData"
                              ...
                              <div>
                                <p
                                  ...
                                  "
                                  v-html="
                                    '评分标准：' + detailInfo.testStandardRemark
                                  "
                                ></p>
                              </div>
                            </TabPane>
              ...
              >
                <div v-if="gradeData.stopList.dataList">
                  <div class="project-info-data">
                    ...
                    <div class="test_project-info">
                      <template
                        v-for="(classTestInfo, indexb) in examItem.list"
                      >
                        <div id="border-hide">
                          <Row>
                            <Col
                              ...
                              <TabPane
                                ...
                                :label="
                                  detailInfo.scorePercent
                                    ? detailInfo.examItemName +
                                      '(' +
                                      (detailInfo.scorePercent / 100).toFixed(
                                        2
                                      ) +
                                      '%)'
                                    : detailInfo.examItemName
          ...
          <Card style="margin-top: 20px" v-if="gradeData.selectList.length > 0">
            <div class="name" v-if="gradeData.selectList.length > 0">
              已选择班级考核项目
            </div>
            <div class="one">
              <div
                class="gradeItem"
                v-for="(item, indexd) in gradeData.selectList"
                :key="indexd"
              >
                ...
                <div class="sections">
                  ...
                  <div class="interview-item__sec">
                    ...
                    <ul>
                      <li
                        v-for="(selectedItem, sindex) in item.actionList"
                        :key="sindex"
                      >
                        <div class="interview-item__name">
                          ...
                          <i class="interview-required__icon">{{
                            selectedItem.examType * 1 === 1 ? "必考" : "选考"
                          }}</i>
                        </div>
                        <ul
                          class="intervier-content"
                          v-if="selectedItem.examItem.length > 1"
                        >
                          <li v-for="exam in selectedItem.examItem" :key="exam">
                            {{ exam }}
                          </li>
                        </ul>
                      </li>
                  ...
                  <div class="interview-item__sec">
                    ...
                    <ul>
                      <li
                        v-for="(selectedItem, sindex) in item.staminaList"
                        :key="sindex"
                      >
                        <div class="interview-item__name">
                          <!-- <span>{{ selectedItem.classTestName }}</span> -->
                ...
                <div class="bottom">
                  考核项目数量：{{
                    item.actionList.length + item.staminaList.length
                  }}
                </div>
...
export default {
  ...
  methods: {
    ...
    getAllGradeClassTestList() {
      ...
      this.$axios
        .get(
          `v1/examtest/getAllGradeClassTestList2?classTestType=${vm.classTestType}`
        )
        .then((res) => {
          vm.loading = false;
          if (res.data.code == 10000) {
