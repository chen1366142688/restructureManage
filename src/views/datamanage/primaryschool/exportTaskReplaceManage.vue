  ...
  <div>
    ...
    <div style="margin-top:15px;">
      <Card>
        ...
        >
          <Button type="success">导入学籍号信息</Button>
        </Upload>
...
export default {
  ...
  methods: {
    ...
    exportData(taskId) {
      ...
      let url =this.$axios.defaults.baseURL +
        "/v1/studentinfo/exportStudentCodeReplaceErrorData?taskId=" +
        taskId +
        "&token=" +
    ...
    exportModel(taskId) {
      var vm = this;
      let url =this.$axios.defaults.baseURL +
        "/v1/studentinfo/exportStudentNumberReplaceModel?token=" +
        sessionStorage.getItem("token");
      window.open(url);
    },
    viewIn() {
    ...
    getTaskList(schoolId,taskType) {
      ...
      this.$axios.post("/v1/studentinfo/getStudentCodeReplaceTaskList", data).then(res => {
        vm.loading = false;
    ...
    countTaskListNum(schoolId,taskType) {
      ...
      this.$axios.post("/v1/studentinfo/getStudentCodeReplaceTaskListCount", data).then(res => {
        if (res.data.code == 10000) {
  ...
  mounted() {
    ...
    vm.taskType=sessionStorage.getItem("studentInfoManage-exportTaskReplaceManage-taskType");
    vm.yearSemester=sessionStorage.getItem("studentInfoManage-exportTaskReplaceManage-yearSemester");
    vm.updateUrl =
      this.$axios.defaults.baseURL +
      "/v1/studentinfo/file/upload/addStudentCodeReplaceTaskInfo?schoolId=" +
      sessionStorage.getItem("schoolId") +
      "&schoolType=" +
      "&token=" + sessionStorage.getItem("token");
    vm.schoolId = schoolId;
    vm.schoolType = schoolType;
    vm.getTaskList(sessionStorage.getItem("schoolId"),sessionStorage.getItem("studentInfoManage-exportTaskReplaceManage-taskType"));
    vm.countTaskListNum(sessionStorage.getItem("schoolId"),sessionStorage.getItem("studentInfoManage-exportTaskReplaceManage-taskType"));
